...
def route_to_specialists(state: State) -> list[Send]:
    """Dispatch parallel specialist agents based on routing flags."""
    tasks = []
...
def privacy_agent(state: State) -> dict:
    ...
    llm = get_llm()
    prompt = f"""Bạn là chuyên gia về bảo vệ dữ liệu cá nhân và GDPR. Phân tích khía cạnh privacy trong câu hỏi:
